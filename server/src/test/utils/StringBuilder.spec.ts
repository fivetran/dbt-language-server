...
describe('StringBuilder', () => {
  ...
  it('appendIf should not add text at the end with false condition', () => {
    ...
    assertThat(stringBuilder.toString(), INITIAL_TEXT);
  });
