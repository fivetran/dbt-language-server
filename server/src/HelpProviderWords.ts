...
export const HelpProviderWords: FunctionInfo[] = [
  ...
  },
  {
    name: 'count',
    signatures: [
      { signature: 'COUNT(*)\n[OVER over_clause]\n', description: 'Returns the number of rows in the input.', parameters: [] },
      {
        signature:
          'COUNT(\n  [ DISTINCT ]\n  expression\n  [ HAVING { MAX | MIN } expression2 ]\n)\n[ OVER over_clause ]\n\nover_clause:\n  { named_window | ( [ window_specification ] ) }\n\nwindow_specification:\n  [ named_window ]\n  [ PARTITION BY partition_expression [, ...] ]\n  [ ORDER BY expression [ { ASC | DESC }  ] [, ...] ]\n  [ window_frame_clause ]\n\n',
  ...
  {
    name: 'is_inf',
    signatures: [{ signature: 'IS_INF(X)\n', description: 'Returns `TRUE` if the value is positive or negative infinity.', parameters: [] }],
  },
  { name: 'is_nan', signatures: [{ signature: 'IS_NAN(X)\n', description: 'Returns `TRUE` if the value is a `NaN` value.', parameters: [] }] },
  {
    name: 'ieee_divide',
    signatures: [
      {
  ...
  {
    name: 'sqrt',
    signatures: [{ signature: 'SQRT(X)\n', description: 'Computes the square root of X. Generates an error if X is less than 0.', parameters: [] }],
  },
  {
    name: 'pow',
    signatures: [
  ...
  { name: 'power', signatures: [{ signature: 'POWER(X, Y)\n', description: 'Synonym of `POW(X, Y)`.', parameters: [] }] },
  {
    name: 'exp',
    signatures: [
      {
  ...
  { name: 'log10', signatures: [{ signature: 'LOG10(X)\n', description: 'Similar to `LOG`, but computes logarithm to base 10.', parameters: [] }] },
  {
    name: 'greatest',
    signatures: [
      {
  ...
  {
    name: 'ceil',
    signatures: [{ signature: 'CEIL(X)\n', description: 'Returns the smallest integral value that is not less than X.', parameters: [] }],
  },
  { name: 'ceiling', signatures: [{ signature: 'CEILING(X)\n', description: 'Synonym of CEIL(X)', parameters: [] }] },
  {
    name: 'floor',
    signatures: [{ signature: 'FLOOR(X)\n', description: 'Returns the largest integral value that is not greater than X.', parameters: [] }],
  },
  {
    name: 'cos',
    signatures: [{ signature: 'COS(X)\n', description: 'Computes the cosine of X where X is specified in radians. Never fails.', parameters: [] }],
  },
  {
    name: 'cosh',
    signatures: [
  ...
  {
    name: 'sin',
    signatures: [{ signature: 'SIN(X)\n', description: 'Computes the sine of X where X is specified in radians. Never fails.', parameters: [] }],
  },
  {
    name: 'sinh',
    signatures: [
  ...
  {
    name: 'asinh',
    signatures: [{ signature: 'ASINH(X)\n', description: 'Computes the inverse hyperbolic sine of X. Does not fail.', parameters: [] }],
  },
  {
    name: 'tan',
    signatures: [
  ...
  {
    name: 'char_length',
    signatures: [{ signature: 'CHAR_LENGTH(value)\n', description: 'Returns the length of the `STRING` in characters.', parameters: [] }],
  },
  { name: 'character_length', signatures: [{ signature: 'CHARACTER_LENGTH(value)\n', description: 'Synonym for CHAR_LENGTH.', parameters: [] }] },
  {
    name: 'chr',
    signatures: [
      {
  ...
  {
    name: 'ltrim',
    signatures: [{ signature: 'LTRIM(value1[, value2])\n', description: 'Identical to TRIM, but only removes leading characters.', parameters: [] }],
  },
  {
    name: 'normalize',
    signatures: [
  ...
  {
    name: 'reverse',
    signatures: [{ signature: 'REVERSE(value)\n', description: 'Returns the reverse of the input `STRING` or `BYTES`.', parameters: [] }],
  },
  {
    name: 'right',
    signatures: [
  ...
  {
    name: 'rtrim',
    signatures: [{ signature: 'RTRIM(value1[, value2])\n', description: 'Identical to TRIM, but only removes trailing characters.', parameters: [] }],
  },
  {
  ...
  {
    name: 'split',
    signatures: [{ signature: 'SPLIT(value[, delimiter])\n', description: 'Splits `value` using the `delimiter` argument.', parameters: [] }],
  },
  {
    name: 'starts_with',
    signatures: [
  ...
  },
  {
    name: 'array_first',
    signatures: [
      { signature: 'ARRAY_FIRST(array_expression)\n', description: 'Takes an array and returns the first element in the array.', parameters: [] },
    ],
  },
  {
    name: 'array_includes',
  ...
  },
  {
    name: 'array_last',
    signatures: [
      { signature: 'ARRAY_LAST(array_expression)\n', description: 'Takes an array and returns the last element in the array.', parameters: [] },
    ],
  },
  {
    name: 'array_length',
  ...
  {
    name: 'array_reverse',
    signatures: [{ signature: 'ARRAY_REVERSE(value)\n', description: 'Returns the input ARRAY with elements in reverse order.', parameters: [] }],
  },
  {
  ...
  {
    name: 'unix_date',
    signatures: [{ signature: 'UNIX_DATE(date_expression)\n', description: 'Returns the number of days since 1970-01-01.', parameters: [] }],
  },
  {
  ...
  },
  {
    ...
    signatures: [
      { signature: 'JUSTIFY_INTERVAL(interval_expression)\n', description: 'Normalizes the days and time parts of the interval.', parameters: [] },
    ],
  },
  {
    name: 'session_user',
    signatures: [{ signature: 'SESSION_USER()\n', description: 'Returns the email address of the user that is running the query.', parameters: [] }],
  },
  {
  ...
  },
  {
    name: 'error',
    signatures: [
      { signature: 'ERROR(error_message)\n', description: 'Returns an error. The `error_message` argument is a `STRING`.', parameters: [] },
    ],
  },
  {
    name: 'iferror',
    signatures: [{ signature: 'IFERROR(try_expression, catch_expression)\n', description: 'Evaluates `try_expression`.', parameters: [] }],
  },
