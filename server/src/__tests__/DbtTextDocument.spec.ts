...
describe('DbtTextDocumentTest', () => {
  ...
  it('findAllJinjas_shouldFindAllJinjas', () => {
        ...
        findAllJinjas_shouldFindAllJinjas('four', [ Range.create(0, 0, 0, 54), Range.create(1, 5, 1, 22), Range.create(1, 43, 1, 58), Range.create(2, 0, 2, 14) ]);
        findAllJinjas_shouldFindAllJinjas('five', [ Range.create(0, 0, 0, 73), Range.create(4, 4, 4, 47), Range.create(5, 36, 5, 54), Range.create(5, 76, 5, 94), Range.create(6, 4, 6, 16) ]);
  });
});
